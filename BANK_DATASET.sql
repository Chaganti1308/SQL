...
-- displaying the records of count 10 (using LIMIT)
SELECT * FROM BANK_DETAILS LIMIT 10;

-- displaying records using  where
SELECT * FROM BANK_DETAILS 
WHERE age = 33;
...
SELECT * FROM BANK_DETAILS 
WHERE 
education = 'unknown' AND marital = 'single';

SELECT * FROM BANK_DETAILS 
WHERE 
(education = 'unknown' OR marital = 'single') AND balance < 500;

-- displaying unique job roles
SELECT DISTINCT job FROM BANK_DETAILS; 

-- ordering data by age in descending order/ASCENDING OREDR
